  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/3 h-full">
        <span style={{ background: catppuccinColor.mantle }} className="my-0 px-4 h-12 leading-12 inline-flex items-center">
          Description
        </span>
        <div style={{ background: catppuccinColor.mantle }} className="h-[calc(100%-3rem-2px)] overflow-y-auto scrollbar-none px-4">
      ...
      <div className="w-[150px] h-full overflow-y-auto scrollbar-none" style={{ background: catppuccinColor.crust }}>
        <span className="h-12 leading-12 inline-flex items-center px-4"> Problems </span>
